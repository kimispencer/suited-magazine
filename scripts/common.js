	...
	magazine: [
		{
			...
			copy: 'Our debut issue celebrates creative, independent thinkers that have charted their own paths in producing work that is at once inspired and inspirational. Working in a variety of media and genres, all live for the autonomy that results from superseding expectation.<br><br>Photographed by Paul Jung, our cover story features four women—Mari Malek, Mari Agory, Nykhor Paul and Atong Arjok—that exemplify this clarity of vision and strength of purpose. All are raising their voices to effect change in their home country of South Sudan. Passionately dedicated to the needs of others, they are opening up a dialogue not only among their fellow citizens but around the world.',
			extra: {
				"0": 'Stephan Cox and Daniel Silver of cult-cool menswear label Duckie Brown considers the duplicity and dual nature of quality versus quantity, alongside a glimpse of their SS15 collection photographed by Conan Thai.<br><br> Photographer Paul Jung and designer Melitta Baumeister find solace and solidarity in their ongoing collaborations, most recently for Baumeister\'s SS15 collection, as it appears in this issue shot by Jung.  <br><br> The founders of Street Etiquette, Joshua Kissi and Travis Gumbs, provoke cultural conversations through their stylized storytelling.  Photography by Matthew Pandolfe.<br><br>',
		...
		},
		{
			...
			extra: {
				"0" : 'Activist, artist and model Gail Bruce\’s passion for Native American educational causes is a lifelong journey. Photographed by Matthew Priestley.<br><br>Artist Sam Moyer\’s carefully salvaged materials, divorced from their utilitarian intent, allow her work an identity all its own.<br><br>Dior Homme\’s Winter 2015/2016 collection paves the way to the future by juxtaposing the traditional with the uber-contemporary. Photographed by Conan Thai.<br><br>Parsons The New School of Design graduates Jon Max Goh and Blair Moore mine their heritage for their award-winning collections. Steven Yatsko photographs their work alongside that of fellow members of the Parsons class of 2015.<br><br>Cult retailer Maryam Nassirzadeh finds inspiration all around her as she steps out with her own brand of retro-modernism, exemplified by her Autumn/Winter 2015 collection as photographed by Joshua Woods.',
				"1" : 'Rick Owens brings his singular aesthetic to furniture in an extraordinary devotion to form and substance.<br><br>Troels Carlsen\’s artworks, grounded in nature yet otherworldly in impact, arise from a collaboration for the ages.<br><br>Brooklyn Circus founder Ouigi Theodore talks American culture, gentrification and fashion as social commentary. Portraits by John Midgely.<br><br>Designer Marta Jakubowski\’s Autumn/Winter 2015 collection, photographed by Evan Browning, is a meditation on love, loss and reconciliation.<br><br>The Quann sisters—UrbanBushBabes co-founder Cipriana and electronic singer-songwriter TK—double up to take on the fashion world while photographer Diego Villarreal captures their singular appeal.',
				"2" : 'British designer Matthew Miller retains his punk ethos while navigating the business of fashion. Selections from his Autumn/Winter 2015 collection are photographed by Daisy Walker.<br><br>Deva Mahal, VBA and Meredith Graves march to their own beat as they make their mark on the music world. Portraits by Matthew Pandolfe.<br><br>Record presser Will Socolov, perfumer Blaise Mautin and milliner Satya Twena dedicate themselves to their crafts, in the process preserving them for a new generation. Portraits by Conan Thai, Diego Villarreal and Justin Bridges.<br><br>Photographer Hans Neumann captures Sara Cummings amid the stark beauty of the Icelandic coast.<br><br>In new work by photographer Nicholas Alan Cope, headwear takes center stage and the beauty lies as much in what is hidden as in what is revealed. Styled by Jessica Willis.'
			}
		},
		{
			issue: 3,
				...
				$('.modal-content').html(
					'<div class="flex-col">'
						...
						+ '<div class="magazine-copy">'
							+ '<h4 class="title" id="IssueNo">Issue No.' + data.issue + '</h4>'
