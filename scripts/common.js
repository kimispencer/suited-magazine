var modalData = {
	magazine: [
		...
		},
		{
			...
			extra: {
				"0" : 'Beloved author, activist, therapist and muse to photographers like Robert Mapplethorpe and Peter Hujar, Robert Levithan exemplified the idea that beauty can be found in the truth, and in living a life true to oneself. Photographed by Zoltan Tombor. *With Robert\'s recent passing on May 13, 2016, we’re honored to present this story in his loving memory.<br><br>Six industry insiders—Linda Rodin, Poppy King, Chris Salgardo, Michelle Harper, Catherine Walsh and Linda Wells—challenge and reflect on what it means to be beautiful. Portraits by David Slijper.<br><br>Photographer Christelle de Castro captures a deeper meaning of beauty as her subjects reveal what beauty means to them.<br><br>For Spring/Summer 2016, Siki Im embraces—even revels in—his insecurities. Photographed by Conan Thai.<br><br>Eduardo Stupía\’s abstract landscapes unite through a singular common language.<br><br>The 85-year-old artist Ibrahim El-Salahi’s most significant series of works according to the “godfather of African Modernism” himself.',
				"1" : 'Photographer Hans Neumann showcases the fluidity of menswear by capturing Tasha on the streets of New York.<br><br>The iconoclastic vision of Sacai\’s Chitose Abe is reflected in her Spring/Summer 2016 collection, as photographed by Christos Karantzolas.<br><br>Devin Allen\’s powerful photographs capture the spirit of his native Baltimore, one year after the uprising.<br><br>Rachel Kneebone\’s sculptural works present complexities as layered as her forms and their influences.<br><br>Beckett Fogg and Piotrek Panszczyk of Area find harmony in dissonance. Evan Browning photographs their Spring/Summer 2016 collection.<br><br>Andrew W.K., shot by Nina Ottolino, preaches a philosophy of perpetual partying.<br><br>Dilly Dally\’s debut album is equal parts sweet and sour. Portrait by Juan José Ortiz.',
				"2" : 'Go behind the scenes as traditional crafts are reworked in extraordinary ways. Yolande Milan Batteau of art studio Callidus Guild and Daniel Friedman of custom tailors Bindle & Keep photographed by Jason Acton; Tim Little of Grenson Shoes photographed by Bex Day.'
			}
		},
		{
			issue: 4,
			...
			extra: {
				"0": 'Art Comes First shares the ethos behind their sartorial collective that\’s got eyes on mediums beyond its genre. <br /><br /> Time and space collide and collapse, according to mixed-media artist Alicja Kwade\’s wonder and will.  <br /><br /> ARC TK <br /><br /> MeLo-X TK <br /><br /> Breaking the mold of expected aesthetics and classic beauty, as photographed by Cyrill Matter. <br /><br /> Photographer Manolo Campion captures the serene malleability between menswear and women\’s.',
				"1" : 'Marland Backus is a model by profession and a jewelry maker by heart, employing certain materials that may surprise. <br /><br /> Jennifer Tzar and Adam Loomis\’ wandering creative pursuits find a home at Ör Gallery and Tavern. <br /><br /> Artist Izumi Kato\’s instincts continue to steer his hands and inform his steps. <br /><br /> Taking the creative reins of the prolific Issey Miyake name, Yusuke Takahashi upholds the avant-garde vision with his own innovation. <br /><br /> Samuel Drira discusses how he\’s given new life to Nehera, a minimalist brand that doesn\’t cut corners.',
				"2" : 'Joe Corré, the man who vows to burn his millions-worth of punk memorabilia this November, is rebelling in a different way with his anti-brands. <br /><br /> Rosie Lowe TK <br /><br /> Alex Mullins TK <br /><br /> Rosetta Getty TK <br /><br /> Psarianos Violins upholds a revered craft that\’s been sustained for hundreds of years. <br /><br /> The Fayed brothers tap into their familial history of classical tailoring to build Bespoken, a rule-breaking brand that\’s turning heads. <br /><br /> World\’s Fair TK <br /><br /> Aurora James TK'
			}
		}
	],
	contact: [
